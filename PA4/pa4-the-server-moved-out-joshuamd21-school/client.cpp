...
void worker_thread_function(BoundedBuffer *request_buffer, BoundedBuffer *response_buffer, TCPRequestChannel *w_chan)
{
...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    TCPRequestChannel *chan = new TCPRequestChannel(ip_addr, portno);
    ...
    for (int i = 0; i < w; i++)
    {
        TCPRequestChannel *work_chan = new TCPRequestChannel(ip_addr, portno); // possibly need to change how these are created and how they are destroyed since we shouldnt send quit messages to server
